...
func TestHardForkDueToFraud_Wasm(t *testing.T) {
	if testing.Short() {
		t.Skip()
	}
...
func Test_HardFork_KickProposer_Wasm(t *testing.T) {
	if testing.Short() {
		t.Skip()
	}
...
// 	// Create DRS deprecation proposal message
// 	msg := map[string]interface{}{
...
// 	proposal := cosmos.TxDRSDeprecationProposal{
// 		Deposit:  "500000000000" + dymension.Config().Denom,
// 		Title:    "drs",
// 		Summary:  "SubmitDRSDeprecationProposal",
// 		Messages: []json.RawMessage{rawMsg},
// 		Metadata: "ipfs://CID",
// 	}
...
// func TestHardForkDueToDrs_Wasm(t *testing.T) {
// 	if testing.Short() {
// 		t.Skip()
// 	}
...
// 	// rollapp1.UpgradeVersion(ctx, client, "ghcr.io/decentrio/rollapp-wasm", "drs-2")

// 	for _, n := range rollapp1.Validators {
// 		n.Image.Version = "drs-2"
// 		n.Image.Repository = "ghcr.io/decentrio/rollapp-wasm"
// 	}
...
func Test_HardFork_BeforeSubmitted_EVM(t *testing.T) {
	if testing.Short() {
		t.Skip()
	}
	...
	maxIdleTime1 := "3s"
	maxProofTime := "500ms"
	configFileOverrides := overridesDymintToml(settlement_layer_rollapp1, settlement_node_address, rollapp1_id, gas_price_rollapp1, maxIdleTime1, maxProofTime, "400s", true)
...
func Test_HardFork_BeforeCanonicalClient_EVM(t *testing.T) {
	if testing.Short() {
		t.Skip()
	}
