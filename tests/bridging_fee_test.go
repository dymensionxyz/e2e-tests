...
func Test_Non_Rollappchain_Unaffected_Wasm(t *testing.T) {
	if testing.Short() {
		t.Skip()
	}
...
func TestChangeBridgeFeeParam_EVM(t *testing.T) {
	if testing.Short() {
		t.Skip()
	}
	...
	fmt.Println("rollappIBCDenom", rollappIBCDenom)
...
func TestChangeBridgeFeeParam_Wasm(t *testing.T) {
	if testing.Short() {
		t.Skip()
	}
