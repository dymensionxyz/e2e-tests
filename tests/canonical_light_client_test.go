...
func TestIBCTransferBetweenHub3rd_Wasm(t *testing.T) {
	if testing.Short() {
		t.Skip()
	}
...
func TestIBCTransferRA_3rdSameChainID_Wasm(t *testing.T) {
	if testing.Short() {
		t.Skip()
	}
	...
	// add modify gaia config so that it has the same chain-id as rollapp1
	gaiaConfig := gaiaConfig.Clone()
	gaiaConfig.ChainID = "rollappwasm_1234-1"
...
func TestIBCTransfer_NoLightClient_Wasm(t *testing.T) {
	if testing.Short() {
		t.Skip()
	}
