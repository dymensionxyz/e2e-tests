...
// This test case verifies the system's behavior when an eIBC packet sent from the rollapp to the hub
// that is fulfilled without having enough balance by the market maker
func TestEIBCFulfillOrderWithoutBalanceNegative(t *testing.T) {
...
// This test case verifies the system's behavior when an eIBC packet sent from the rollapp to the hub
// that is not fulfilled by a market maker
func TestEIBCNotFulfilled(t *testing.T) {
